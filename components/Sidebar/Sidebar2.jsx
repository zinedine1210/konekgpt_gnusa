...
export default function Sidebar2() {
  return (
    <aside className="flex flex-col w-2/12 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-zinc-900 dark:border-zinc-700">
        <div className="flex flex-col justify-between flex-1 mt-14">
            <nav className="flex-1 -mx-3 space-y-3 ">
                ...
                <a className="flex items-center px-3 py-2 text-zinc-600 transition-colors duration-300 transform rounded-lg dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 dark:hover:text-zinc-200 hover:text-zinc-700" href="#">
            ...
            <div className="mt-6">
                ...
                <div className="flex items-center justify-between mt-6">
                    <a href="#" className="flex items-center gap-x-2">
                        ...
                        <span className="text-sm font-medium text-zinc-700 dark:text-zinc-200">John Doe</span>
                    </a>
                    
                    <a href="#" className="text-zinc-500 transition-colors duration-200 rotate-180 dark:text-zinc-400 rtl:rotate-0 hover:text-blue-500 dark:hover:text-blue-400">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
