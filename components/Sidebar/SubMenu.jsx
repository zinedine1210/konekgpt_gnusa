...
export default function SubMenu({ menus }) {
  ...
  return (
    <aside className={`${context.view == 2 ? "fixed top-0 left-0 w-screen h-screen z-20":"hidden xl:block"} xl:z-0 xl:relative h-screen xl:w-60 pt-16 bg-white dark:bg-darkPrimary dark:border-darkSecondary border-r`}>
