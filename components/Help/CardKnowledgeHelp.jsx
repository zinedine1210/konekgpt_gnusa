                        ...
                        <div className="mt-5 space-y-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <div>
                                    ...
                                    <label for="react-option" className="inline-flex items-center justify-between w-full p-3 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:border-blue-600 hover:text-gray-600 dark:peer-checked:text-gray-300 peer-checked:text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 peer-checked:bg-blue-50">                           
                                ...
                                <div>
                                    ...
                                    <label for="react-option2" className="inline-flex items-center justify-between w-full p-3 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:border-blue-600 hover:text-gray-600 dark:peer-checked:text-gray-300 peer-checked:text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 peer-checked:bg-blue-50">                           
                                        <h1 className="text-sm">Lorem ipsum dolor, sit amet</h1>
                                    </label>
                                </div>
                                <div>
                                    <input type="checkbox" id="react-option3" value="" className="hidden peer" required="" />
                                    <label for="react-option3" className="inline-flex items-center justify-between w-full p-3 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:border-blue-600 hover:text-gray-600 dark:peer-checked:text-gray-300 peer-checked:text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 peer-checked:bg-blue-50">                           
                                        <h1 className="text-sm">Lorem ipsum dolor, sit amet</h1>
                                    </label>
                                </div>
                                <div>
                                    <input type="checkbox" id="react-option4" value="" className="hidden peer" required="" />
                                    <label for="react-option4" className="inline-flex items-center justify-between w-full p-3 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:border-blue-600 hover:text-gray-600 dark:peer-checked:text-gray-300 peer-checked:text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 peer-checked:bg-blue-50">                           
                                        <h1 className="text-sm">Lorem ipsum dolor, sit amet</h1>
                                    </label>
                                </div>
                                <div>
                                    <input type="checkbox" id="react-option5" value="" className="hidden peer" required="" />
                                    <label for="react-option5" className="inline-flex items-center justify-between w-full p-3 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:border-blue-600 hover:text-gray-600 dark:peer-checked:text-gray-300 peer-checked:text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 peer-checked:bg-blue-50">                           
                                        <h1 className="text-sm">Lorem ipsum dolor, sit amet</h1>
                                    </label>
                                </div>
                            </div>
