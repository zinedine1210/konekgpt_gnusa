        ...
        <section className="w-full bg-zinc-100 relative h-screen flex">
          <div className={`${context.view == 2 ? "fixed top-0 left-0 w-screen h-screen z-20":"hidden md:block"} md:z-0 md:relative md:w-1/6 bg-white pt-16`}>
            ...
            <div className="space-y-2 mt-2">
                <button onClick={() => handlerRedirect("/usr/qna/faq")} className="w-full hover:bg-zinc-100 transition-all duration-300 py-2 px-3 flex gap-2 cursor-pointer relative items-center">
                ...
                <button onClick={() => handlerRedirect("/usr/qna/unanswer-question")} className="w-full hover:bg-zinc-100 transition-all duration-300 py-2 px-3 flex gap-2 cursor-pointer relative items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5">
