        ...
        <td class="px-4 py-4 text-sm font-medium text-zinc-700 whitespace-nowrap">
            <div class="inline-flex items-center gap-x-3">
                ...
                <div class="flex items-center gap-x-2">
                    <div class="flex items-center justify-center w-8 h-8 text-blue-500 bg-blue-100 rounded-full dark:bg-zinc-800">
                    ...
                    <div>
                        ...
                        <p class="text-xs font-normal text-zinc-500 dark:text-zinc-400">20 Question</p>
                    </div>
                </div>
            </div>
        </td>
        <td class="px-12 py-4 text-sm font-normal text-zinc-700 whitespace-nowrap">
            20
        </td>
        <td class="px-4 py-4 text-sm text-zinc-500 dark:text-zinc-300 whitespace-nowrap">Jan 4, 2022</td>
        <td class="px-4 py-4 text-sm text-zinc-500 dark:text-zinc-300 whitespace-nowrap">Jan 4, 2022</td>
        <td class="px-4 py-4 text-sm text-zinc-500 dark:text-zinc-300 whitespace-nowrap">Lana Steiner</td>
