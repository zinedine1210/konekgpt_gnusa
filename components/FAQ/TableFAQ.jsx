  ...
  return (
    <section class="">
        <div class="sm:flex sm:items-center sm:justify-between">
            <input type="search" placeholder="Search List" className="input-search" />
        ...
        <div class="flex flex-col mt-6">
            <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                    <div class="overflow-hidden border border-zinc-200 dark:border-zinc-700 md:rounded-lg">
                        <table class="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700">
                            <thead class="bg-zinc-50 dark:bg-zinc-800">
                                <tr>
                                    ...
                                    <th scope="col" class="px-12 py-3.5 text-sm font-normal text-left rtl:text-right text-zinc-500 dark:text-zinc-400">
                                        Number of Questions
                                    </th>
