  ...
  return (
    <div className="relative group hover:bg-blue-50">
        <div className={`md:flex items-center p-2 gap-2`}>
            ...
            <h1 className="text-xs md:text-sm">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolor labore voluptas aliquam quod ad nesciunt nemo ipsa dignissimos, eaque facilis?</h1>
        </div>
