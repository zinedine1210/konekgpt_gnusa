  ...
  return (
    <>
        <div className="w-full bg-blue-100 dark:bg-blue-900 px-2 xl:px-5 py-5 xl:py-10 flex items-center gap-5">
            <BsSkype className="text-blue-500 text-9xl"/>
            <div>
                <h1 className="text-xl mb-3 font-bold">Skype</h1>
        ...
        <div className="xl:flex mx-2 xl:mx-5 gap-5">
                    ...
                    data ? data > 0 ? new Array(data).fill("mantap").map((load, key) => {
                        return (
                            <div key={key} className="border-2 border-zinc-300 p-4 flex items-center justify-between">
                                ...
                                <TfiSkype className="text-blue-500 text-xl"/>
            ...
            <div className="w-full xl:w-1/2 bg-white dark:bg-darkPrimary xl:-mt-32 rounded-md p-5 shadow-md h-full">
                <h1 className="text-xl mb-5">Skype Channel Integration</h1>
                <p className="text-sm text-zinc-500">You can only connect with skype bots, if you use personal skype it {`won't`} work.</p>
