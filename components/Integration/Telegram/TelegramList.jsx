...
export default function TelegramList() {
  return (
    <>
        <div className="w-full bg-blue-100 px-2 md:px-5 py-5 md:py-10 flex items-center gap-5">
            <FaTelegram className="text-blue-500 text-9xl"/>
            <div>
                <h1 className="text-xl mb-3">Telegram</h1>
                <p className="text-zinc-500">Start communicating with your customers via Telegram.</p>
            </div>
        </div>
        <div className="md:flex mx-2 md:mx-5 gap-5">
            <div className="w-full md:w-1/2 h-full py-5 space-y-2">
                <div className="border-2 border-zinc-300 p-4 flex items-center justify-between">
                    ...
                    <h1 className="text-zinc-600 font-bold">Zinedine Bot</h1>
                    </div>
            ...
            <div className="w-full md:w-1/2 bg-white md:-mt-32 rounded-md p-5 shadow-md h-full">
