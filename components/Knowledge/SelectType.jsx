...
return (
  <div ref={dropRef} className="relative">
    ...
    <div className={`${open ? "visible opacity-100":"opacity-0 invisible"} transition-all duration-300 bg-white z-20 rounded-md shadow-md w-full md:w-[850px] absolute top-full right-0 mt-1 px-5 py-3`}>
