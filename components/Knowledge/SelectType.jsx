...
return (
  <div ref={dropRef} className="relative">
    ...
    <div className={`${open ? "visible opacity-100":"opacity-0 invisible"} transition-all duration-300 bg-white dark:bg-darkPrimary z-20 rounded-md shadow-md w-full xl:w-[850px] absolute top-full right-0 mt-1 px-5 py-3`}>
      <h1 className="text-zinc-600 dark:text-white font-bold">Create New Attchment</h1>
      <p className="text-zinc-500 dark:text-zinc-300 font-light text-xs">Build your bot story from scratch or get started right away by importing a pre-build, task-specific template.</p>
      <div className="gap-2 mt-3 grid grid-cols-1 xl:grid-cols-2">
        ...
        {/* <Link href={"/usr/knowledge/attachment/create_v2/scratch?m=clm_knowledge_attachment"}> */}
          <button disabled className="disabled:bg-zinc-200 dark:disabled:bg-black disabled:relative disabled:cursor-not-allowed text-start w-full block p-3 border border-zinc-200 rounded-md hover:border-blue-500">
