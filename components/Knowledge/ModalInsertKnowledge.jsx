    ...
    <div className="absolute w-full h-full bg-black backdrop-blur-md bg-opacity-40 overflow-y-auto left-0 top-0 z-20 flex items-center justify-center">
        <div className="bg-white w-full md:w-1/2 mx-auto rounded-md p-5">
          <div className="flex items-center justify-between">
            ...
            <p className="text-sm">This action will be direct you to training Knowledge page</p>
            <form onSubmit={e => handlerSubmit(e)} className='my-5 space-y-4'>
                ...
                
                {
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button type="button" onClick={() => context.setData({...context, modal:null})} className="btn-secondary">Cancel</button>
                    </div>
                }
            </form>
        </div>
