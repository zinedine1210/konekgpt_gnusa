...
export default function ModalSingleContact() {
  ...
  return (
    <div className="fixed w-full h-screen bg-black backdrop-blur-md bg-opacity-40 overflow-y-auto left-0 top-0 z-50 flex items-center justify-center">
      <div className="bg-white w-full xl:w-1/4 mx-auto rounded-md p-5">
        ...
        <form className="w-full relative mt-5 space-y-2">
          <div>
            <label htmlFor="namecontact" className="inline-block mb-1 text-sm">
            ...
            <input
              ...
              placeholder="Give a name to your new contact"
            />
          </div>
          <div>
            <label htmlFor="phonecontact" className="inline-block mb-1 text-sm">
          ...
          <div>
            <label htmlFor="emailcontact" className="inline-block mb-1 text-sm">
