            ...
            <div className="lg:flex lg:items-center lg:justify-between">
                <div className="flex items-center justify-between w-full">
                    ...
                    <div className="flex items-center">
                        <button className="mx-4 text-white transition-colors duration-300 transform lg:block dark:text-zinc-200 hover:text-zinc-700 dark:hover:text-zinc-400 focus:text-zinc-700 dark:focus:text-zinc-400 focus:outline-none" aria-label="show notifications">
