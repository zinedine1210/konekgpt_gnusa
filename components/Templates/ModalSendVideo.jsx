...
export default function ModalSendVideo() {
    ...
    const handlerSubmit = async () => {
        ...
        const result = await WhatsappRepository.sendVideo({id:context.chatInfo.parentId, data:{instance_key:context.chatInfo.parentId, jid:jidUser, videoUrl:data, caption:caption}})
        console.log(result);
        if(result.success){
    ...
    if(context.modal)
    if(context.modal == "modalsendvideo")
    return (
