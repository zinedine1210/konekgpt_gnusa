    ...
    <section className='w-full h-screen'>
      ...
      <div className="container mx-auto py-2 px-2 md:px-32">
        <button className={`flex gap-1`}>
            <div className="flex items-center gap-2">
                <span className="font-extrabold text-3xl md:text-4xl block text-lightPrimary">Konek</span>
            </div>
            <p className="self-end text-xs font-extrabold uppercase mb-1">Gpt</p>
        </button>
      </div>
      ...
      <div className="w-full md:w-1/2 rounded-[40px] overflow-hidden shadow-2xl mx-auto mt-5 flex">
        ...
        <div className="w-full md:w-1/2 px-5 py-14">
          ...
          <p className="mt-2">Dan dapatkan banyak fitur untuk keperluan bisnis Anda</p>
          ...
          <form className="space-y-3 mt-5">
            ...
            <div className="pt-5">
              ...
              <p className="text-center mt-3 text-zinc-500">Sudah punya akun? <Link href={"/"}><button className="text-blue-500 font-bold">Masuk</button></Link></p>
            </div>
          </form>
        </div>
      </div>
