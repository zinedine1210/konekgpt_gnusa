...
export default function EditContact() {
  ...
  useEffect(() => {
    if(!data) setData(JSON.parse(localStorage.getItem("auth")).data)
  }, [data])
  return (
            ...
            <div className="mx-0 xl:mx-2 xl:flex gap-2">
              <div className="w-full xl:w-1/4 bg-white dark:bg-darkPrimary rounded-md shadow-md p-3 xl:p-5">
                ...
                <div className="flex items-center gap-2 py-3">
                  <div className="user-avatar bg-blue-500 w-16 h-16 text-white text-2xl uppercase">
                  ...
                  <div>
                    ...
                    <p className="font-light text-sm text-gray-500 mt-1">
                      {data?.message}: 27 Jan 2023, 17:34 PM
                    </p>
                  </div>
                </div>
