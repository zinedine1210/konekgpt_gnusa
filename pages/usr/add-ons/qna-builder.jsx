...
export default function HalamanAddEvent() {
  ...
  const handlerEvent = async () => {
    ...
    data[0].menus.find(res => res.id == "clm_qna" || res.parent == "clm_qna").show = true
    
    localStorage.setItem("client_menus", JSON.stringify(data))
    context.setData({...context, menus:data})

    router.push("/usr/qna/service?m=clm_qna")
  }
