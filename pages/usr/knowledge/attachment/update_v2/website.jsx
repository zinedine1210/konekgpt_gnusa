...
export default function UpdateWebsiteKnowledge() {
                    ...
                    <div className='mx-0 md:mx-2'>
                        {
                            ...
                            <div className='bg-white rounded-md shadow-md p-3 md:p-5'>
                                <label className="text-base md:text-xl dark:text-zinc-400 font-semibold">Update Information Website-Knowledge</label>
                                ...
                                <div className="flex items-center gap-2 pt-1 pb-3">
                                    ...
                                    /
                                    <h1 className="text-sm">Update Website</h1>
                                </div>
                            ...
                            :
                                <div className='w-full md:w-1/2 h-[500px] bg-zinc-200 animate-pulse rounded-md shadow-md'></div>
                        }
                    </div>
                </div>
            </section>
