            ...
            <section className="w-full bg-zinc-100 relative h-screen flex">
                <div className="w-full md:w-1/2 relative h-screen pt-16 overflow-y-auto">
                    ...
                    <div className='bg-white rounded-md shadow-md p-3 md:p-5'>
                        <label className="text-base md:text-xl dark:text-zinc-400 font-semibold">Create Knowledge base from PDF</label>
                        ...
                        <form onSubmit={e => handlerSubmit(e)} className='my-5 space-y-4'>
                            <div>
                                <label htmlhtmlFor='namepdf' className='font-bold inline-block mb-2 text-sm'>Name <span className='text-red-500'>*</span></label>
                                <input onChange={(e) => setData({...data, name:e.target.value})} value={data.name} id='namepdf' type="text" className="input-search w-full" placeholder='Give a name to your new data source' />
                            </div>
                            <div>
                            ...
                            <div className="w-full">
                                {
                                    ...
                                    <label
                                        ...
                                        <input type="file" name="file_upload" accept=".pdf" multiple className="hidden" onChange={(e) => handlerUploadPDF(e)}/>
                                    </label>
                                }
                            </div>
                            {
