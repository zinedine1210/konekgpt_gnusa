            ...
            <section className="w-11/12 bg-zinc-100 relative h-screen flex">
                <div className="w-full relative h-screen pt-16 overflow-y-auto">
                    ...
                    <div className='bg-white rounded-md shadow-md p-5'>
                        <label class="text-zinc-500 text-xl uppercase dark:text-zinc-400 font-semibold">Create Knowledge base from scratch</label>
                        <div className="flex items-center gap-2 pt-1 pb-3">
                            ...
                            /
                            <h1 class="text-sm">Build From Scratch</h1>
                        </div>

                        <div className='my-5 space-y-5'>
                            <div>
                                <label htmlFor='nameofscratch' className='font-bold inline-block mb-2'>Name <span className='text-red-500'>*</span></label>
                                <input id='nameofscratch' type="text" className="w-full block bg-zinc-50 text-sm py-2 px-5 outline-none border-2 hover:bg-zinc-100 focus:bg-white focus:border-ligthPrimary" placeholder='Give a name to your new data source' />
                            </div>
                            ...
                            <div>
                                ...
                                <div className='relative'>
                                    ...
                                    <textarea name="description" id="textareaofscratch" className='block w-full bg-zinc-50 text-sm py-2 px-5 outline-none border-2 hover:bg-zinc-100 focus:bg-white focus:border-ligthPrimary resize-y' rows={30} >
                                    </textarea>
                                </div>
                            </div>
                        </div>
