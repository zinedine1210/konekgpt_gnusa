            ...
            <section className="w-11/12 bg-zinc-100 relative h-screen flex">
                <div className="w-full relative h-screen pt-16 overflow-y-auto">
                    ...
                    <div className='bg-white rounded-md shadow-md p-5'>
                        <label class="text-zinc-500 text-xl uppercase dark:text-zinc-400 font-semibold">Create Knowledge base from Website</label>
                        <div className="flex items-center gap-2 pt-1 pb-3">
                            ...
                            /
                            <h1 class="text-sm">Build From Website</h1>
                        </div>
