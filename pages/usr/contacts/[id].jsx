...
import { FaChevronDown, FaChevronLeft, FaTelegramPlane, FaWhatsapp } from "react-icons/fa";
            ...
            <div className='mx-0 md:mx-2 md:flex gap-2'>
              <div className='w-full md:w-1/4 bg-white rounded-md shadow-md p-3 md:p-5'>
                ...
                <div className="flex items-center gap-2 py-3">
                    ...
                    <div>
                        <h1 className="font-bold text-xl">Zinedine Ziddan Fahdlevy</h1>
                        <p className="font-light text-sm text-gray-500 mt-1">Last Active: 27 Jan 2023, 17:34 PM</p>
                    </div>
                </div>
                    ...
                    <div className="space-y-2 mt-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-gray-500 text-sm font-light">Zinedine Bot</p>
                        </div>
                      </div>
                    </div>
                </div>
              ...
              <div className="w-full md:w-3/4 bg-white rounded-md shadow-md p-5">
                ...
                <div className="border-t pt-4 mt-4">
                  ...
                  <div className="p-2">
                    <h1 className="font-bold text-red-500 text-sm">No Campaigns</h1>
                  </div>
                </div>
              </div>
            </div>
