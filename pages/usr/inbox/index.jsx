    ...
    <Layout title="HOME" desc="HALAMAN UTAMA">
      <Suspense fallback={"Loading"}>
        <section className="w-full bg-zinc-100 relative h-screen flex">
          <div className={`${context.view == 2 ? "fixed top-0 left-0 w-screen h-screen z-20":"hidden md:block"} md:z-0 md:relative md:w-1/5 bg-white pt-16 mt-1`}>
          ...
          <div className={`w-full md:w-4/5 bg-zinc-100 relative h-screen pt-16 pb-20 md:pb-24`}>
            <div className="h-full overflow-y-auto">
              <div className="space-y-2 w-full px-2 md:px-0 md:w-2/3 mx-auto">
                  ...
                  <div className="ml-auto w-full">
                    ...
                    <div className="space-y-2">
                      <div className="w-fit backdrop-blur-2xl pt-1 pb-6 px-1 shadow-md rounded-md max-w-xl ml-auto relative">
                        <h1 className="text-xs md:text-sm">Lorem ipsum dolor, sit amet consectetur adipisicing Coba.</h1>
                        <span className="absolute bottom-1 right-1 text-xs font-light text-zinc-500">11.00</span>
                      </div>
                      <div className="w-fit backdrop-blur-2xl pt-1 pb-6 px-1 shadow-md rounded-md max-w-xl ml-auto relative">
                        <h1 className="text-xs md:text-sm">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Odio saepe libero amet ipsum magni ullam? In odit voluptatibus vero nobis.</h1>
                        <span className="absolute bottom-1 right-1 text-xs font-light text-zinc-500">11.00</span>
                      </div>
                    </div>
                  </div>
                  <span className="hidden w-8 h-8 rounded-full bg-zinc-200 md:flex items-center justify-center font-bold border-2 border-white">Y</span>
                </div>
                <div className="flex gap-2">
                  <span className="hidden w-8 h-8 rounded-full bg-zinc-200 md:flex items-center justify-center font-bold border-2 border-white">Z</span>
                  <div className="w-full">
                    ...
                    <div className="space-y-2">
                      <div className="w-fit bg-white pt-1 pb-6 px-1 shadow-md rounded-md max-w-xl relative">
                        <h1 className="text-xs md:text-sm">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta quasi reprehenderit ipsam dolorem ex cumque rerum illum ut assumenda consequatur eos, hic veniam non soluta quaerat, voluptates error. Quam, asperiores.</h1>
                        <span className="absolute bottom-1 right-1 text-xs font-light text-zinc-500">11.00</span>
                      </div>
                      <div className="w-fit bg-white pt-1 pb-6 px-1 shadow-md rounded-md max-w-xl relative">
                        <h1 className="text-xs md:text-sm">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta quasi</h1>
                        <span className="absolute bottom-1 right-1 text-xs font-light text-zinc-500">11.00</span>
                      </div>
                    </div>
                  </div>
