            ...
            <div className='px-3 absolute top-0 bg-white dark:bg-darkPrimary left-0 w-full shadow-md pt-16 z-20'>
              <div className="flex items-center justify-between">
                ...
                <div ref={dropRef} className="relative">
                  ...
                  <div className={`${open ? "":"hidden"} absolute top-full right-0 shadow-md rounded-md backdrop-blur-md w-44 overflow-hidden`}>
                    <button onClick={() => context.setData({...context, modal:"modalcreategroup"})} className="hover:bg-blue-100 dark:hover:bg-blue-500 px-3 py-2 text-sm w-full text-start">
                      Create Group
                    </button>
                    <button onClick={() => context.setData({...context, allChatList:null})} className="hover:bg-blue-100 dark:hover:bg-blue-500 px-3 py-2 text-sm w-full text-start">
                      Refresh Chat List
                    </button>
                  </div>
                </div>
